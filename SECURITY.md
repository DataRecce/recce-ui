...
Please report (suspected) security vulnerabilities to **security@reccehq.com**. You will receive a response from us within 48 hours. In the response, we will confirm whether the vulnerability was indeed found, and we will discuss the steps towards a solution.
